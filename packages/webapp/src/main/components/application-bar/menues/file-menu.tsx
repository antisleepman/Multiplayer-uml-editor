      ...
      <>
        <NavDropdown id="file-menu-item" title="File" className="pt-0, pb-0" onClick={this.showMenu}>
          ...
          <Dropdown id="export-dropdown" drop="right">
            ...
            >
              <span className="flex-grow-1">Экспорт</span>
            </Dropdown.Toggle>
            <Dropdown.Menu>
              <Dropdown.Item onClick={(event: any) => this.exportDiagram('SVG')}>SVG</Dropdown.Item>
              ...
              <Dropdown.Item onClick={(event: any) => this.exportDiagram('JSON')}>JSON</Dropdown.Item>
              <Dropdown.Item onClick={(event: any) => this.exportDiagram('PDF')}>PDF</Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
        </NavDropdown>
      </>
