              ...
              <div className="popover-content" id="theme-switch-popover-content">
                ...
                {this.isDarkMode() && (
                  <div className="description">
                    <span>
                    Вы можете щелкнуть этот значок в любое время, чтобы отключить темный режим, если у вас возникнут проблемы.
                    </span>
                  </div>
                )}
                {!this.isDarkMode() && (
                  <div className="description">
                    <span>Попробуйте темный режим и разгрузите глаза.</span>
                  </div>
                )}
              </div>
            </Tooltip>
